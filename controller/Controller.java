...
public class Controller extends AbstractController implements Runnable
{
    ...
    public void finances(){
        GeldView.CreateAndShowGeld();
    }

    public static double getFinances() { return Model.getGeld(); }
    public static int getParkingPassAantal(){ return Model.getParkingPassCars();}
    public static int getAdHocCarsAantal(){return Model.getAdHocCars();}
    ...
    public void incrementAdHocCarDay(){run = false; model.adHocCarDay(10); run = true;}
    public void incrementAdHocCarEnd(){run = false; model.adHocCarEnd(10); run = true;}
    public void incrementParkingPassDay(){run = false; model.parkingPassDay(10); run = true;}
    public void incrementParkingPassEnd(){run = false; model.parkingPassEnd(10); run = true;}
    public void incrementReservations(){run = false; model.reservationsIncrement(10); run = true;}
